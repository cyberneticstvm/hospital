$(function () {
    ...
    $(".spectacle .le_dist_add").change(function () {
        ...
        if (age < 52 && le_dist_add > 0 && le_dist_sph) {
            var int_sph = (parseFloat(le_dist_sph)) ? parseFloat(le_dist_sph) + 0.75 : 0.75;
            $(".le_int_sph").val((int_sph > 0) ? '+' + int_sph.toFixed(2) : (int_sph) ? int_sph.toFixed(2) : '');
        } else if (age > 52 && le_dist_add > 0 && le_dist_sph) {
    ...
    $(".chkREtoLE").click(function () {
        if ($(this).is(":checked")) {
            ...
            $(".tbodyre td").each(function () {
                ...
                $(".tbodyle td:eq(" + c + ")").find('input, select').val(val);
                $(".tbodyle td:eq(" + c + ")").find('select').select2();
                c++;
            });
            $(".le_dist_add").val($(".re_dist_add").val());
        } else {
        ...
        $('.re_dist_add, .le_dist_add').select2();
    });
