$(function () {
    ...
    $('#dTblApp, #dataTblMed, #dTblSurgery').dataTable({
        responsive: true,
        dom: 'Bfrtip',
        buttons: [
            'excel',
    ...
    $(".addPharmacyRow").click(function () {
        $(".tblPharmacy").append("<tr><td><select class='form-control form-control-sm select2 selProduct selProductForTransfer' data-placeholder='Select' required='required' name='product[]'><option value=''>Select</option></select></td><td><select class='form-control form-control-sm select2 selBatchNo bno' name='batch_number[]' required='required'><option value=''>Select</option></select></td><td><input type='number' class='form-control form-control-sm text-end qty' step='any' min='1' name='qty[]' value='1' placeholder='0' required='required'/></td><td><input type='text' class='form-control form-control-sm' name='dosage[]' placeholder='Dosage'/></td><td><input type='text' class='form-control form-control-sm' name='duration[]' placeholder='Duration'/></td><td><input type='number' class='form-control form-control-sm text-end mrp' step='any' name='mrp[]' placeholder='0.00' required='required'/></td><td><input type='number' class='form-control form-control-sm text-end disc' step='any' name='discount[]' placeholder='0.00' /></td><td><input type='number' class='form-control form-control-sm text-end taxp' step='any' name='tax[]' placeholder='0%' /></td><td><input type='number' class='form-control form-control-sm text-end taxa' step='any' name='tax_amount[]' placeholder='0.00' /></td><td><input type='number' class='form-control form-control-sm text-end price' step='any' name='price[]' placeholder='0.00' required='required'/></td><td><input type='number' class='form-control form-control-sm text-end total' step='any' name='total[]' placeholder='0.00' required='required' /></td><td class='text-center'><a href='javascript:void(0)' onClick='$(this).parent().parent().remove()'><i class='fa fa-trash text-danger'></i></a></td></tr>");
        $('.selProduct').select2(); $('.selBatchNo').select2();
        bindDDL('medicine', 'selProduct');
    });
    $(".addPharmacyRowB2B").click(function(){
        $(".tblPharmacy").append("<tr><td><select class='form-control form-control-sm select2 selProduct selProductForTransfer' data-placeholder='Select' required='required' name='product[]'><option value=''>Select</option></select></td><td><select class='form-control form-control-sm select2 selBatchNo bno' data-type='b2b' name='batch_number[]' required='required'><option value=''>Select</option></select></td><td><input type='number' class='form-control form-control-sm text-end qty' step='any' min='1' name='qty[]' value='1' placeholder='0' required='required'/></td><td><input type='number' class='form-control form-control-sm text-end mrp' step='any' name='mrp[]' placeholder='0.00' required='required'/></td><td><input type='number' class='form-control form-control-sm text-end disc' step='any' name='discount[]' placeholder='0.00' /></td><td><input type='number' class='form-control form-control-sm text-end taxp' step='any' name='tax[]' placeholder='0%' /></td><td><input type='number' class='form-control form-control-sm text-end taxa' step='any' name='tax_amount[]' placeholder='0.00' /></td><td><input type='number' class='form-control form-control-sm text-end price' step='any' name='price[]' placeholder='0.00' required='required'/></td><td><input type='number' class='form-control form-control-sm text-end total' step='any' name='total[]' placeholder='0.00' required='required' /></td><td class='text-center'><a href='javascript:void(0)' onClick='$(this).parent().parent().remove()'><i class='fa fa-trash text-danger'></i></a></td></tr>");
        $('.selProduct').select2(); $('.selBatchNo').select2();
        bindDDL('medicine', 'selProduct');
    })
