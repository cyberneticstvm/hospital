            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body table-responsive">
                        ...
                        <form action="{{ route('oct.update', $oct->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="notes" value="{{ $oct->notes }}" class="form-control form-control-md" />
                                </div>
                            </div>
