        ...
        <div class="row g-4">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="d-flex flex-wrap justify-content-between align-items-end">
                    <div class="mb-3">
                        <h5 class="mb-0">Create Tonometry</h5>
                ...
                <div class="card">
                    <div class="card-body table-responsive">
                        ...
                        <form action="{{ route('tonometry.save') }}" method="post">
                            @csrf
                                ...
                                <div class="col-sm-12 table-responsive">
                                    <table class="table table-bordered" style="width:30%; margin:0 auto;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Time</td>
                                                <td><input type="text" class="form-control" name="nct_time" value="{{ date('h:i a') }}"></td>
                                                <td><input type="text" class="form-control" name="at_time" value="{{ date('h:i a') }}"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
