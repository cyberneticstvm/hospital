                ...
                <div class="card">
                    <div class="card-body table-responsive">
                        <table class="table table-sm dataTable table-striped table-hover align-middle">
                            <thead>
                                <tr>
                                    <th colspan="5" class="text-center fw-bold"><a class="daybook" href="javascript:void(0)" data-bs-toggle="modal" data-modal="outstandingDueModal" data-bs-target="#outstandingDueModal" data-title="Outstanding Due Detailed" data-fdate="{{ ($inputs) ? $inputs[0] : $today }}" data-tdate="{{ ($inputs) ? $inputs[1] : $today }}" data-branch="{{ ($inputs && $inputs[2]) ? $inputs[2] : 0 }}" data-type="outstanding">Show Outstanding Due</a></th>
                                </tr>
                                <tr>
                                    <th>SL No.</th>
                                    <th>Particulars</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end"><a class="daybook text-danger" href="javascript:void(0)" data-bs-toggle="modal" data-modal="procedureDiscountModal" data-bs-target="#procedureDiscountModal" data-title="Procedure Discount Detailed" data-fdate="{{ ($inputs) ? $inputs[0] : $today }}" data-tdate="{{ ($inputs) ? $inputs[1] : $today }}" data-branch="{{ ($inputs && $inputs[2]) ? $inputs[2] : 0 }}" data-type="procedureDiscount">{{ number_format($procedure_fee_discount, 2) }}</a></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end"><a class="daybook text-danger" href="javascript:void(0)" data-bs-toggle="modal" data-modal="surgConModal" data-bs-target="#surgConModal" data-title="Surgery Consumables Detailed" data-fdate="{{ ($inputs) ? $inputs[0] : $today }}" data-tdate="{{ ($inputs) ? $inputs[1] : $today }}" data-branch="{{ ($inputs && $inputs[2]) ? $inputs[2] : 0 }}" data-type="sc">{{ number_format($surgery_consumables - $surgery_consumables_discount, 2) }}</a></td>
                                </tr>
                                <tr>
                                    <td>14</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end fw-bold">{{ number_format($income_total+$outstanding_received-($income_received_upi + $income_received_card + $expense + $outstanding + $disc_total), 2) }}</td>
                                    <td></td>
...
<div class="modal fade" id="surgConModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-vertical modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary"></h5>
