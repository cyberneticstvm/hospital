                ...
                <div class="card">
                    <div class="card-body table-responsive">
                        <table class="table table-sm dataTable table-striped table-hover align-middle">
                            ...
                            <tr>
                                <td>13</td><td>Income from Surgery Consumables</td><td class="text-end">{{ number_format($surgery_consumables, 2) }}</td><td class="text-end">{{ number_format($surgery_consumables, 2) }}</td>       
                            </tr>
                            <tr>
