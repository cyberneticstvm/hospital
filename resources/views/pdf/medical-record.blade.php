...
<body>
    ...
    <p>Vision</p>
    <table width="100%" cellspacing="0" cellpadding="0">
        <thead class=""><tr><th>&nbsp;</th><th>VB</th><th>SPH</th><th>CYL</th><th>AXIS</th><th>ADD</th><th>VA</th><th>VA</th><th></th></tr></thead>
        <tbody>
            <tr>
                ...
                <td>{{ ($spectacle) ? $record->re_dist_va : '--' }}</td>
            ...
            <tr>
                ...
                <td>{{ ($spectacle) ? $record->le_dist_va : '--' }}</td>
