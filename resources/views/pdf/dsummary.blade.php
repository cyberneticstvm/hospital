...
<body>
    ...
    <table width="100%" cellpadding='0' cellspacing='0' class="text-large bordered">
        <tr>
            ...
            <td colspan="3">{{ $ds->medical_record_id }}</td>
            <td>Patient ID</td>
            <td>{{ $ds->patient->patient_id }}</td>
        </tr>
        <tr>
            <td>Name/Age/Gender</td>
            <td colspan="3">{{ $ds->patient->patient_name }} / {{ $ds->patient->age }} / {{ $ds->patient->gender }}</td>
            <td>Date</td>
            <td>{{ $ds->created_at->format('d-m-Y') }}</td>
        </tr>
        <tr>
            <td>Address</td>
            <td colspan="3">{{ $ds->patient->address }}</td>
            <td>Hospital ID</td>
            <td>{{ $ds->branches->hospital_id }}</td>
        </tr>
        <tr>
            <td>D.O.A</td>
        ...
        <tr>
            ...
            <td colspan="5">{{ $ds->reason_for_admission }}</td>
        </tr>
        <tr>
            <td>Findings</td>
            <td colspan="5">{{ $ds->findings }}</td>
        </tr>
        <tr>
            <td>Investigation Results</td>
            <td colspan="5">{{ $ds->investigation_result }}</td>
        </tr>
        <tr>
            <td>General Examination</td>
            <td colspan="5">{{ $ds->general_examination }}</td>
        </tr>
        <tr>
            <td>Diagnosis</td>
            <td colspan="5">{{ $ds->diagnosis }}</td>
        </tr>
        <tr>
            <td>Procedure</td>
            <td colspan="5">{{ $ds->procedure }}</td>
        </tr>
        <tr>
            <td>Condition at Discharge</td>
            <td colspan="5">{{ $ds->discharge_condition }}</td>
        </tr>
        <tr>
            <td>Medication</td>
            <td colspan="5">{{ $ds->medication }}</td>
        </tr>
        <tr>
            <td></td>
            <td colspan="5">
        ...
        <tr>
            ...
            <td colspan="5">{{ $ds->special_instruction }}</td>
        </tr>
        <tr>
