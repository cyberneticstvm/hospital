...
<body>
    ...
    <table width="100%" class="">
        <tr>
            <td>Date: {{ ($mrecord->created_at) ? date('d/M/Y', strtotime($mrecord->created_at)) : '' }}</td>
            <td class="text-right">Medical Record Number: {{ $mrecord->id }}</td>
        </tr>
        <tr>
            ...
            <tr>
                <td style="background:url(./images/assets/x-png-30.png); background-repeat: no-repeat; background-size: auto;" width="50%">
                    <table cellpadding="0" cellspacing="0" width="100%" style="border: 0px;">
                        <tr>
                            <td colspan="3" class="text-center" style="padding-bottom:75px; border: 0px;">{{ $mrecord->gonio_od_top }}</td>
                        </tr>
                        <tr>
                            <td style="border: 0px;">{{ $mrecord->gonio_od_left }}</td>
                            <td style="border: 0px;"></td>
                            <td class="text-right" style="border: 0px;">{{ $mrecord->gonio_od_right }}</td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-center" style="padding-top:75px; border: 0px;">{{ $mrecord->gonio_od_bottom }}</td>
                        </tr>
                    </table>
                </td>
                <td style="background:url(./images/assets/x-png-30.png); background-repeat: no-repeat; background-size: auto; height:20%" width="50%">
                    <table cellpadding="0" cellspacing="0" width="100%" style="border: 0px;">
                        <tr>
                            <td colspan="3" class="text-center" style="padding-bottom:75px; border: 0px;">{{ $mrecord->gonio_os_top }}</td>
                        </tr>
                        <tr>
                            <td style="border: 0px;">{{ $mrecord->gonio_os_left }}</td>
                            <td style="border: 0px;"></td>
                            <td class="text-right" style="border: 0px;">{{ $mrecord->gonio_os_right }}</td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-center" style="padding-top:75px; border: 0px;">{{ $mrecord->gonio_os_bottom }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td class="text-center">{{ $mrecord->gonio_od }}</td>
                <td class="text-center">{{ $mrecord->gonio_os }}</td>
            </tr>
        </tbody>
    </table>
    <br>
    ...
    <table border="0" width="100%" cellspacing="1px" cellpadding="">
        <tbody>
            ...
            <tr>
                ...
                <td width="50%"><img src="{{ ($retina_od && $retina_od[$key]->retina_img) ? Helper::domain_url().'/public/storage/'.$retina_od[$key]->retina_img : '' }}" width='100%' /><br>{{ ($retina_od && $retina_od[$key]->description) ? $retina_od[$key]->description : '' }}</td>
                @else
                <td width="50%"></td>
                @endif
                @if($retina_os && !empty($retina_os[$key]))
                <td width="50%"><img src="{{ ($retina_os && $retina_os[$key]->retina_img) ? Helper::domain_url().'/public/storage/'.$retina_os[$key]->retina_img : '' }}" width='100%' /><br>{{ ($retina_os && $retina_os[$key]->description) ? $retina_os[$key]->description : '' }}</td>
                @else
                <td width="50%"></td>
                @endif
            </tr>
    ...
    <table width="100%" class="no-border">
        <tr>
            <th>{{ ($mrecord->is_patient_admission == 'sel') ? '' : 'Admission Advised:' }}</th>
            <th>{{ ($mrecord->is_patient_surgery == 'sel') ? '' : 'Surgery Advised:' }} </th>
            <th class="text-right">{{ ($mrecord->review_date) ? 'Review Date:' : '' }}</th>
        </tr>
        <tr>
            <th>{{ ($mrecord->is_patient_admission == 'sel') ? '' : $mrecord->is_patient_admission }}</th>
            <th>{{ ($mrecord->is_patient_surgery == 'sel') ? '' : $mrecord->is_patient_surgery }}</th>
            <th class="text-right">{{ ($mrecord->review_date) ? date('d/M/Y', strtotime($mrecord->review_date)) : '' }}</th>
        </tr>
    </table>
    <br>
