...
@forelse($mrecords as $key => $mrecord)
    ...
    <div>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    <td width="50%">
                        <img src="https://hospital.speczone.net/public/storage/{{ $pachymetry->img1 }}" width="100%" /><br/>
    ...
    <table width="100%" class="no-border">
        <tr><th>{{ ($mrecord->is_patient_admission == 'sel') ? '' : 'Admission Advised:' }}</th><th>{{ ($mrecord->is_patient_surgery == 'sel') ? '' : 'Surgery Advised:' }} </th><th class="text-right">{{ ($mrecord->review_date) ? 'Review Date:' : '' }}</th></tr>
