                        ...
                        <form action="{{ route('onote.save') }}" method="post">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <textarea name="medications_prescribed" class="form-control" rows="5" placeholder="Medications Prescribed">1. Tab. Cefixime 200 mg – 1 tablet in the morning and 1 tablet in the evening for 3 days<br/>2. Tab. Pantop 40 mg – Take 1 tablet daily<br/>3. Tab. Dolo (SoS)</textarea>
