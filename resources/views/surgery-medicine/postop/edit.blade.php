        ...
        <div class="row g-4">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="d-flex flex-wrap justify-content-between align-items-end">
                    <div class="mb-3">
                        <h5 class="mb-0">Update Post Operative Medicine</h5>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row g-4 mb-3">
                            <div class="col-sm-3">MR.ID: <h5 class="text-primary">{{ $medicine->medical_record_id }}</h5></div>
                        ...
                        <form action="{{ route('postop.medicine.update', $medicine->id) }}" method="post">
                            @csrf
                            @method("PUT")
                            ...
                            <input type="hidden" name="type" value="postop" />
                                    ...
                                    <table class="table table-bordered table-sm">
                                        ...
                                        <tbody class="tblPharmacy">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" class="form-control form-control-sm text-end total" step="any" name="tax_amount[]" value="{{ $med->tax_amount }}" placeholder="0.00" /></td>
