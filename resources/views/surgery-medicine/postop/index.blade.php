...
<div class="d-flex flex-wrap justify-content-between align-items-end">
    <div class="mb-3">
        <h5 class="mb-0">Post Operative Medicine Register</h5>
        ...
        <table id="dataTbl" class="table table-striped table-hover align-middle table-sm" style="width:100%">
            ...
            @foreach($postops as $pop)
                <tr>
                    ...
                    <td><a class='btn btn-link' href="{{ route('postop.medicine.update', $pop->id) }}"><i class="fa fa-pencil text-warning"></i></a></td>
                    <td>
                        <form method="post" action="{{ route('postop.medicine.delete', $pop->id) }}">
                            @csrf 
                            @method("DELETE")
