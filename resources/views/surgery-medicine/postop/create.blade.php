        ...
        <div class="row g-4">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="d-flex flex-wrap justify-content-between align-items-end">
                    <div class="mb-3">
                        <h5 class="mb-0">Create Post Operative Medicine</h5>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row g-4 mb-3">
                            <div class="col-sm-3">MR.ID: <h5 class="text-primary">{{ $surgery->medical_record_id }}</h5>
                            </div>
                        ...
                        <form action="{{ route('postop.medicine.save') }}" method="post">
                            @csrf
