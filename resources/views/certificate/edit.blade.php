                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('certificate.update', $certificate->id) }}" method="post">
                            ...
                            <div class="row g-4">
                                <div class="col-sm-4">Patient Name: <h5 class="text-primary">{{ $certificate->patient_name }}</h5>
                                </div>
                                <div class="col-sm-4">Patient ID: <h5 class="text-primary">{{ $certificate->patient_id }}</h5>
                                </div>
                                <div class="col-sm-4">Doctor Name: <h5 class="text-primary">{{ $certificate->doctor_name }}</h5>
                                </div>
