                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-12 table-responsive">
                                ...
                                <thead><tr><th>SL No.</th><th>Patient Name</th><th>Patient ID</th><th>Age</th><th>Phone Number</th><th>Address</th><th>Branch</th><th>Reg. Date</th></tr></thead><tbody>
                                @php $i = 0; @endphp
                                @forelse($patients as $key => $row)
                                    <tr>
                                        <td>{{ ++$i }}</td>
