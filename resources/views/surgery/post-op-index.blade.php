...
<div class="card mb-4 border-0">
    <div class="card-body">
        ...
        <table id="dataTbl" class="table table-striped table-hover align-middle table-sm" style="width:100%">
            <thead><tr><th>SL No.</th><th>MR ID.</th><th>Patient Name</th><th>Patient ID</th><th>Phone Number</th><th>Doctor Name</th><th>Surg. Date</th><th>Surgery Name</th><th>Eye</th><th>Surgeon</th><th>Status</th><th>notes</th><th>History</th></tr></thead><tbody>
            @php $i = 0; @endphp
