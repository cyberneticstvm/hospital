                    ...
                    <div class="card-body">
                        <form action="{{ route('surgery.update', $surgery->id) }}" method="post">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-4">Doctor Name: <h5 class="text-primary">{{ $doctor->doctor_name }}</h5>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-3">
                                    <label class="form-label">Advised Branch </label>
                                    <input type="text" value="{{ $surgery->advised_branch }}" name="advised_branch" class="form-control form-control-md" maxlength="49" placeholder="Advised Branch">
                                    @error('advised_branch')
                                    <small class="text-danger">{{ $errors->first('advised_branch') }}</small>
                                    @enderror
                                </div>
                                <div class="col-sm-12">
