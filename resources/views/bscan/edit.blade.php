            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body table-responsive">
                        ...
                        <form action="{{ route('bscan.update', $bscan->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="file" name="documents[]" class="form-control form-control-md" multiple />
                                    @forelse($docs->where('doc_type', 'pdf') AS $key => $item)
                                    <small><a href="{{ ($item) ? public_path().'/storage/'.$item->doc_url : '#' }}" target="_blank">Document Uploaded</a></small><br>
                                    @empty
                                    @endforelse
                                    @error('documents')
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="notes" value="{{ $bscan->notes }}" class="form-control form-control-md" />
                                </div>
                            </div>
