                        ...
                        <form action="{{ route('customer.create') }}" method="post">
                            ...
                            <div class="row g-4">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" value="{{ old('name') }}" name="name" class="form-control form-control-md" placeholder="Customer Name">
                                    @error('name')
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="text" name="gstin" value="{{ old('gstin') }}" class="form-control form-control-md" placeholder="GSTIN">
                                </div>
                                <div class="col-sm-2">
                                    <label class="form-label">Opening Balance</label>
                                    <input type="number" name="opening_balance" value="{{ old('opening_balance') }}" class="form-control form-control-md" placeholder="0.00">
