        ...
        <div class="row g-4">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="d-flex flex-wrap justify-content-between align-items-end">
                    <div class="mb-3">
                        <h5 class="mb-0">Create Payment for {{ $customer->name }}</h5>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('customer.account.create', encrypt($customer->id)) }}" method="post">
                            @csrf
                            <div class="row g-4">
                                <div class="col-sm-3">
                                    <label class="form-label">Payment Date<sup class="text-danger">*</sup></label>
                                    {{ Form::date('pdate', (old('pdate')) ?? date('Y-m-d'), ['class' => 'form-control']) }}
                                    @error('pdate')
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="number" name="amount" value="{{ old('amount') }}" class="form-control form-control-md" placeholder="0.00">
                                    @error('amount')
