    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('promotion.contact.save') }}" method="post">
                            @csrf
                            <div class="row g-4">
                                <div class="col-md-4">
                                    <label class="form-label req">Customer Name</label>
                                    {{ Form::text($name = 'name', old('name'), ['class' => 'form-control', 'placeholder' => 'Customer Name']) }}
                                    @error('name')
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ Form::text($name = 'contact_number', old('contact_number'), ['class' => 'form-control', 'placeholder' => 'Contact Number', 'maxlength' => 10]) }}
                                ...
                                <div class="col-md-2">
                                    ...
                                    {{ Form::select('type', array('include' => 'Include', 'exclude' => 'Exclude'), old('type'), ['class' => 'form-control', 'placeholder' => 'Select']) }}
                                    @error('type')
