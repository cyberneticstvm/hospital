                            ...
                            <div class="row g-4 mt-3">
                                <div class="col-sm-5">
                                    <table class="table table-borderless" style="background:url({{ public_path().'/images/assets/x-png-30.png' }}); background-repeat: no-repeat; background-position: center;">
                                        <tr>
                                            <td></td>
                                            <td width="20%"><input type="text" class="form-control" name="gonio_od_top" value="{{ $record->gonio_od_top }}" placeholder="0" /></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td><input type="text" class="form-control" name="gonio_od_left" value="{{ $record->gonio_od_left }}" placeholder="0" /></td>
                                            <td class="text-center"></td>
                                            <td><input type="text" class="form-control" name="gonio_od_right" value="{{ $record->gonio_od_right }}" placeholder="0" /></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td><input type="text" class="form-control" name="gonio_od_bottom" value="{{ $record->gonio_od_bottom }}" placeholder="0" /></td>
                                            <td></td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class="col-sm-5">
                                    <table class="table table-borderless" style="background:url({{ public_path().'/images/assets/x-png-30.png' }}); background-repeat: no-repeat; background-position: center;">
                                        <tr>
                                            <td></td>
                                            <td width="20%"><input type="text" class="form-control" name="gonio_os_top" value="{{ $record->gonio_os_top }}" placeholder="0" /></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td><input type="text" class="form-control" name="gonio_os_left" value="{{ $record->gonio_os_left }}" placeholder="0" /></td>
                                            <td class="text-center"></td>
                                            <td><input type="text" class="form-control" name="gonio_os_right" value="{{ $record->gonio_os_right }}" placeholder="0" /></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td><input type="text" class="form-control" name="gonio_os_bottom" value="{{ $record->gonio_os_bottom }}" placeholder="0" /></td>
                                            <td></td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div class="row g-4 mt-1">
                                <div class="col-sm-6">
                                    ...
                                    <div class="retina_od_container mt-3 mb-3">
                                        ...
                                        <div class='imgrow'><img src="{{ ($retina->retina_img) ? public_path().'/storage/'.$retina->retina_img : '' }}" class='img-fluid mt-1 mb-1' alt='' />
                                            <div class='row '>
                                                <div class='col-sm-10'><input type='text' class='form-control' name='retina_desc[]' value="{{ $retina->description }}" placeholder='Description'><input type='hidden' name='retina_img[]' value="{{ ($retina->retina_img) ? base64_encode(file_get_contents(storage_path('app/public/'.$retina->retina_img))) : '' }}"><input type='hidden' name='retina_type[]' value="{{ $retina->retina_type }}"><input type='hidden' name='lab_test_id[]' value='0'></div>
                                                <div class='col-sm-2 '><a href='javascript:void(0)'><i class='fa fa-trash text-danger removeImg'></i></a></div>
                                            </div>
                                        </div>
                                        @endforeach
                                        @endif
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="retina_os_container mt-3 mb-3">
                                        ...
                                        <div class='imgrow'><img src="{{ public_path().'/storage/'.$retina->retina_img }}" class='img-fluid mt-1 mb-1' alt='' />
                                            <div class='row '>
                                                <div class='col-sm-10'><input type='text' class='form-control' name='retina_desc[]' value="{{ $retina->description }}" placeholder='Description'><input type='hidden' name='retina_img[]' value="{{ ($retina->retina_img) ? base64_encode(file_get_contents(storage_path('app/public/'.$retina->retina_img))) : ''}}"><input type='hidden' name='retina_type[]' value="{{ $retina->retina_type }}"><input type='hidden' name='lab_test_id[]' value='0'></div>
                                                <div class='col-sm-2 '><a href='javascript:void(0)'><i class='fa fa-trash text-danger removeImg'></i></a></div>
                                            </div>
