                    ...
                    <div class="col-lg-12 col-md-4 col-sm-12">
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center bg-transparent border-bottom-0">
                                <div>
                                    <h6 class="card-title m-0">Patient Overview Current month - <span class="text-primary">{{ DB::table('branches')->where('id', Session::get('branch'))->value('branch_name') }}</span></h6>
                                    <small class="text-muted">Or you can <a href="#">sync data to Dashboard</a> to ensure your data is always up-to-date.</small>
                                </div>
                            </div>
                            <div class="card-body">
                ...
                <div class="row g-3 row-deck">
                    <div class="col-lg-12 col-md-4 col-sm-12">
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center bg-transparent border-bottom-0">
                                <div>
                                    <h6 class="card-title m-0">Review Overview Current month - <span class="text-primary">{{ DB::table('branches')->where('id', Session::get('branch'))->value('branch_name') }}</span></h6>
                                    <small class="text-muted">Or you can <a href="#">sync data to Dashboard</a> to ensure your data is always up-to-date.</small>
                                </div>
                            </div>
                            <div class="card-body">
        ...
        <div class="row">
            <div class="col-6">
                <div class="card">
                    <div class="card-header py-3 d-flex flex-wrap  justify-content-between align-items-center bg-transparent border-bottom-0">
                        <div>
                            <h6 class="card-title m-0">Pharmacy Direct Current Month - <span class="text-primary">{{ DB::table('branches')->where('id', Session::get('branch'))->value('branch_name') }}</span></h6>
                            <small class="text-muted">Or you can <a href="#">sync data to Dashboard</a> to ensure your data is always up-to-date.</small>
                        </div>
                        <div class="dropdown">
                            <button class="btn btn-sm btn-link text-muted d-none d-sm-inline-block" type="button"><i class="fa fa-download"></i></button>
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-header py-3 d-flex flex-wrap  justify-content-between align-items-center bg-transparent border-bottom-0">
                        <div>
                            <h6 class="card-title m-0">Pharmacy Out Current Month - <span class="text-primary">{{ DB::table('branches')->where('id', Session::get('branch'))->value('branch_name') }}</span></h6>
                            <small class="text-muted">Or you can <a href="#">sync data to Dashboard</a> to ensure your data is always up-to-date.</small>
                        </div>
                        <div class="dropdown">
                            <button class="btn btn-sm btn-link text-muted d-none d-sm-inline-block" type="button"><i class="fa fa-download"></i></button>
                    ...
                    <div class="card-body">
                        <div class="card-header border">
                            <div class="d-flex flex-row align-items-center">
                                Pharmacy Out Overview
                            </div>
                        </div>
                        <div id="pharmacyOutMonth"></div>
                    </div>
                </div>
            </div>
        </div>
