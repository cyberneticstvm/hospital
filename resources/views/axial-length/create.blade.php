            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body table-responsive">
                        ...
                        <form action="{{ route('procedure.axial.save') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row g-4">
                                <div class="col-sm-2">
                                    ...
                                    <input type="text" value="{{ old('axl') }}" name="axl" maxlength="9" class="form-control form-control-md" placeholder="AXL">
                                </div>
                                <div class="col-sm-2">
                                    <label class="form-label">ACD </label>
                                    <input type="text" value="{{ old('acd') }}" name="acd" maxlength="9" class="form-control form-control-md" placeholder="ACD">
                                </div>
                                <div class="col-sm-2">
                                    <label class="form-label">LENS </label>
                                    <input type="text" value="{{ old('lens') }}" name="lens" class="form-control form-control-md" maxlength="9" placeholder="LENS">
                                </div>
                            </div>
