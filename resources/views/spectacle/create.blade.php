                        ...
                        <form action="{{ route('spectacle.save') }}" method="post">
                                ...
                                <div class="col-sm-6 table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>DIST.</td>
                                                <td><input type="text" class="form-control form-control-md" name="re_dist_sph" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="re_dist_cyl" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="re_dist_axis" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="re_dist_va" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="re_dist_prism" placeholder="0"/></td>
                                            </tr>
                                            <tr>
                                                <td>INT.</td>
                                                <td><input type="text" class="form-control form-control-md" name="re_int_sph" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="re_int_cyl" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="re_int_axis" placeholder="0"/></td>
                                            ...
                                            <tr>
                                                <td>NEAR.</td>
                                                <td><input type="text" class="form-control form-control-md" name="re_near_sph" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="re_near_cyl" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="re_near_axis" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="re_near_va" placeholder="0"/></td>
                                ...
                                <div class="col-sm-6 table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>DIST.</td>
                                                <td><input type="text" class="form-control form-control-md" name="le_dist_sph" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="le_dist_cyl" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="le_dist_axis" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="le_dist_va" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="le_dist_prism" placeholder="0"/></td>
                                            </tr>
                                            <tr>
                                                <td>INT.</td>
                                                <td><input type="text" class="form-control form-control-md" name="le_int_sph" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="le_int_cyl" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="le_int_axis" placeholder="0"/></td>
                                            ...
                                            <tr>
                                                <td>NEAR.</td>
                                                <td><input type="text" class="form-control form-control-md" name="le_near_sph" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="le_near_cyl" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="le_near_axis" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="le_near_va" placeholder="0"/></td>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control form-control-md" name="ipd" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="npd" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="rpd" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="lpd" placeholder="0"/></td>
                            ...
                            <div class="row g-4">
                                <div class="col-sm-2">
                                    ...
                                    <input type="text" maxlength="7" value="{{ old('re_iop') }}" name="re_iop" class="form-control form-control-md" placeholder="0">
                                </div>
                                <div class="col-sm-2">
                                    <label class="form-label">IOP/L</label>
                                    <input type="text" maxlength="7" value="{{ old('le_iop') }}" name="le_iop" class="form-control form-control-md" placeholder="0">
                                </div>
                            </div>
                            <div class="row mt-3">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" value="{{ old('diagnosis') }}" name="diagnosis" class="form-control form-control-md" placeholder="Diagnosis">
                                </div>
                                <div class="col-sm-4">
