                                ...
                                <div class="col-sm-3 table-responsive">
                                    ...
                                    <table class="table spectacle">
                                        ...
                                        <tbody class="">
                                            <tr>
                                                <td>R</td>
                                                <td><input type="text" maxlength="7" value="{{ old('re_iop') }}" name="re_iop" class="form-control form-control-md" placeholder="0"></td>
                                                <td><input type="text" maxlength="7" class="form-control form-control-md" placeholder="0"></td>
                                            </tr>
                                            <tr>
                                                <td>L</td>
                                                <td><input type="text" maxlength="7" value="{{ old('le_iop') }}" name="le_iop" class="form-control form-control-md" placeholder="0"></td>
                                                <td><input type="text" maxlength="7" class="form-control form-control-md" placeholder="0"></td>
                                            </tr>
                                            <tr>
                                                <td>Time</td>
                                ...
                                <div class="col-sm-6 table-responsive">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody class="">
                                            <tr>
                                                <td>OD</td>
                                                <td><input type="text" class="form-control form-control-md" name="pgp_od_sph" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="pgp_od_cyl" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="pgp_od_axis" placeholder="0"/></td>
                                            ...
                                            <tr>
                                                <td>OS</td>
                                                <td><input type="text" class="form-control form-control-md" name="pgp_os_sph" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="pgp_os_cyl" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="pgp_os_axis" placeholder="0"/></td>
                                ...
                                <div class="col-sm-12 table-responsive">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody class="">
                                            <tr>
                                                <td>OD</td>
                                                <td><input type="text" class="form-control form-control-md" name="bm_k1_od_a" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="bm_k2_od_a" placeholder="0"/></td>
                                                ...
                                                <td><input type="text" class="form-control form-control-md" name="bm_od_kvalue_a" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="bm_od_iol" placeholder="0"/></td>
                                            </tr>
                                            <tr>
                                                <td>OS</td>
                                                <td><input type="text" class="form-control form-control-md" name="bm_k1_os_a" placeholder="0"/></td>
                                                <td><input type="text" class="form-control form-control-md" name="bm_k2_os_a" placeholder="0"/></td>
                                                ...
                                                <td><input type="text" class="form-control form-control-md" name="bm_os_kvalue_a" placeholder="0"/></td>
