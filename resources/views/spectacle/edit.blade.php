                        ...
                        <form action="{{ route('spectacle.update', $spectacle->id) }}" method="post">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-sm-6 table-responsive mb-3">
                                    <table><thead><tr><th colspan="4">OD - Uncorrected Visual Acuity</th><th colspan="2"><input type="text" class="form-control form-control-md" name="vbr" value="{{ $spectacle->vbr }}" placeholder="0"/></th></tr></thead></table>
                                </div>
                                <div class="col-sm-6 table-responsive mb-3">
                                    <table><thead><tr><th colspan="4">OS - Uncorrected Visual Acuity</th><th colspan="2"><input type="text" class="form-control form-control-md" name="vbl" value="{{ $spectacle->vbl }}" placeholder="0"/></th></tr></thead></table>
                                </div>
                                <div class="col-sm-6 table-responsive">
                                    <table class="table spectacle">
                                        ...
                                        <tbody class="tbodyre">
                                            ...
                                            <tr>
                                                <td class="fw-bold">ADD</td><td><!--<input type="text" class="form-control form-control-md re_dist_add" name="re_dist_add" value="{{ $spectacle->re_dist_add }}" placeholder="0"/>-->
                                ...
                                <div class="col-sm-6 table-responsive">
                                    <table class="table spectacle">
                                        ...
                                        <tbody class="tbodyle">
                                            ...
                                            <tr>
                                                <td class="fw-bold">ADD</td><td><!--<input type="text" class="form-control form-control-md le_dist_add" name="le_dist_add" value="{{ $spectacle->le_dist_add }}" placeholder="0"/>-->
