        ...
        <table id="dataTbl" class="table display table-sm dataTable table-striped table-hover align-middle" style="width:100%">
            ...
            @foreach($labs as $lab)
                <tr>
                    ...
                    <td>{{ $lab->ldate }}</td>
                    <td><a href="/lab/radiology/result/{{ $lab->medical_record_id }}/" target="_blank"><i class="fa fa-pencil text-muted"></i></a></td>
                    <td><a href="/lab/radiology/report/{{ $lab->medical_record_id }}/" target="_blank"><i class="fa fa fa-file-pdf-o text-primary"></i></a></td>
                    <td><a href="/lab/radiology/prescription/{{ $lab->medical_record_id }}/" target="_blank"><i class="fa fa fa-file-pdf-o text-danger"></i></a></td>
                    <td><a href="/lab/radiology/bill/{{ $lab->medical_record_id }}/" target="_blank"><i class="fa fa fa-file-pdf-o text-success"></i></a></td>
