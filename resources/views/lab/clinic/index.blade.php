        ...
        <table id="dataTbl" class="table display table-sm dataTable table-striped table-hover align-middle" style="width:100%">
            ...
            @foreach($labs as $lab)
                <tr>
                    ...
                    <td>{{ $lab->ldate }}</td>
                    <td><a href="/lab/clinic/result/{{ $lab->medical_record_id }}/" target="_blank"><i class="fa fa-file-o text-muted"></i></a></td>
                    <td><a href="/lab/clinic/report/{{ $lab->medical_record_id }}/" target="_blank"><i class="fa fa-file-o text-info"></i></a></td>
                    <td><a href="/lab/clinic/prescription/{{ $lab->medical_record_id }}/" target="_blank"><i class="fa fa-file-o text-danger"></i></a></td>
                    <td><a href="/lab/clinic/bill/{{ $lab->medical_record_id }}/" target="_blank"><i class="fa fa-file-o text-warning"></i></a></td>
