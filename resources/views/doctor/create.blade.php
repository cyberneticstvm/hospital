                        ...
                        <form action="{{ route('doctor.create') }}" method="post">
                            ...
                            <div class="row g-4">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" value="{{ old('doctor_name') }}" name="doctor_name" class="form-control form-control-md" placeholder="Doctor Name">
                                    @error('doctor_name')
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" value="{{ old('designation') }}" name="designation" class="form-control form-control-md" placeholder="Designation">
                                    @error('designation')
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" value="{{ old('additional_qualification') }}" name="additional_qualification" class="form-control form-control-md" placeholder="Add. Qualification">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="text" value="{{ old('reg_no') }}" name="reg_no" class="form-control form-control-md" placeholder="Registration No.">
                                    @error('reg_no')
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <fieldset class="form-icon-group left-icon position-relative">
                                        <input type="text" value="{{ old('date_of_join') }}" name="date_of_join" class="form-control form-control-md dtpicker" placeholder="dd/mm/yyyy">
