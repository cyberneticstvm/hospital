...
class AppointmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Config::set('myconfig.sms.message', "Dear ".$request->patient_name.", Your appointment has been scheduled on ".$request->appointment_date." ".$request->appointment_time.", for enquiry please Call 9995050149. Thank You, Devi Eye Hospital. ".$br->short_name);
        try{
