...
class ReportController extends Controller
{
    ...
    public function fetchdaybook(Request $request){
        ...
        $opening_balance = DB::table('daily_closing as d')->select(DB::raw("IFNULL(d.closing_balance, 0) AS closing_balance"))->whereDate('d.date', '=', $prev_day)->where('d.branch', $request->branch)->orderByDesc('d.id')->first()->closing_balance;
