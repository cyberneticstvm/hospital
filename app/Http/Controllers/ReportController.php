...
class ReportController extends Controller
{
    ...
    public function fetchPurchase(Request $request)
    {
        ...
        if ($request->type == 'c'):
            ...
            })->selectRaw("p.id AS pid, DATE_FORMAT(p.delivery_date, '%d-%b-%Y') AS delivery_date, p.invoice_number, s.name AS sname, pd.purchase_price, pd.tax_amount, pd.total")->get();
        endif;
