...
class ReportController extends Controller
{
    ...
    public function fetchdaybook(Request $request)
    {
        ...
        $patientOutStandingTotal = Helper::getPatientOutstanding(null, null, $request->branch);
