...
class PatientPaymentController extends Controller
{
    ...
    public function oustandingDueFetch(Request $request){
        ...
        $outstandings = PatientPayment::selectRaw("SUM(CASE WHEN type = 8 THEN amount END) AS due, SUM(CASE WHEN type = 9 THEN amount END) AS received, SUM(CASE WHEN type = 8 THEN amount END) - SUM(CASE WHEN type = 9 THEN amount END) AS balance, patient_id")->where('branch', $brn)->groupBy('patient_id')->get();
        return view('patient-payment.outstanding-due', compact('branches', 'outstandings', 'brn'));
    }
}
