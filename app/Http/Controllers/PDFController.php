...
class PDFController extends Controller
{
    ...
    public function medicalrecord($id){
        ...
        $retinas = DB::table('patient_medical_records_retina')->where('medical_record_id', $id)->get();
