...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/pharmacyoutmonth/', [DashboardController::class, 'pharmacyOutMonth'])->name('dash.pharmacy.out.month');
...
Route::group(['middleware' => ['auth', 'branch', 'location']], function () {
    ...
    Route::get('/reports/purchase', 'App\Http\Controllers\ReportController@purchase')->name('reports.patient.pharmacy');
